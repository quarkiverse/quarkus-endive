...
public class WasmQuarkusContext {
     ...
     *
     * @return The module name as configured via {@code quarkus.endive.modules.<module-key>.name}
     */
    ...
    /**
     * Returns a {@link Function} that implements a {@link run.endive.compiler.internal.MachineFactory},
     * based on the configuration and runtime environment.
     *
     * @return A {@link Function} that implements a {@link run.endive.compiler.internal.MachineFactory}
     */
